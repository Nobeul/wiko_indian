...
<div class="container ps-4 pe-4">
    <form method="post" class="mb-4" action="{{ url('sellers/'.$seller->id) }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" readonly class="form-control" value="{{ old('email', $seller->email) }}">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="state" value="{{ old('state', $seller->state) }}">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="address" value="{{ old('address', $seller->address) }}">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="company_name" value="{{ old('company_name', $seller->company_name) }}">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <select class="form-control" name="is_kyc_verified">
                    <option value="0" {{ $seller->is_kyc_verified ==0 ? 'selected' : '' }}>No</option>
                    <option value="1" {{ $seller->is_kyc_verified ==1 ? 'selected' : '' }}>Yes</option>
                </select>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <select class="form-control" name="is_payment_verified">
                    <option value="0" {{ $seller->is_payment_verified ==0 ? 'selected' : '' }}>No</option>
                    <option value="1" {{ $seller->is_payment_verified ==1 ? 'selected' : '' }}>Yes</option>
                </select>
                @if ($errors->first('is_kyc_verified'))
                    <p class="text-danger small">{{ $errors->first('is_kyc_verified') }}
                    </p>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <select name="is_recommended" id="is_recommended" class="form-control">
                    <option value="0" {{ $seller->is_recommended == 0 ? 'selected' : '' }}>No</option>
                    <option value="1" {{ $seller->is_recommended == 1 ? 'selected' : '' }}>Yes</option>
                </select>
        ...
        @if (count($seller->verifications) > 0)
            @foreach ($seller->verifications as $verification)
                <div class="mb-3 row">
        ...
        @endif
        <div class="mb-3 row">
            <label for="inputPassword" class="col-sm-2 col-form-label">Seller Picture</label>
            <div class="col-sm-10">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                @if ($seller->profile_image)
                    <img src="{{ asset('public/admin/assets/img/avatars/'.$seller->profile_image) }}" alt="Seller profile image" class="img-fluid">
                @else 
                    <img src="{{ asset('public/admin/assets/img/avatars/default-profile.png') }}" alt="Seller profile image" class="img-fluid">
                @endif
            </div>
        </div>
